# -*- coding: utf-8 -*-
"""[Klasifikasi]_Submission_Akhir_BMLP_Latief_Naufal_Andryanto.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1A4LOBy9exMQvgj2Itx6TfVLQ9f4-8DM3
...
X = df_encoded.drop(columns=['Target', 'Cluster'])
...
# Buat (instantiate) objek dari algoritma tuning (GridSearchCV)
#  - 'estimator': Model yang akan di-tuning
#  - 'param_grid': Hyperparameter yang sudah kita tentukan
